...
public class StartFr1Screen extends AbstractContainerScreen<StartFr1Menu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, "Ces ticket vous permettent de", 11, 25, -12829636);
		this.font.draw(poseStack, "voyager librement sur la carte", 11, 43, -12829636);
		this.font.draw(poseStack, "durant 1h \u00E0 partir du moment", 11, 61, -12829636);
		this.font.draw(poseStack, "d'activation", 11, 79, -12829636);
		this.font.draw(poseStack, "Voici les taris des tickets :", 11, 106, -12829636);
	}
