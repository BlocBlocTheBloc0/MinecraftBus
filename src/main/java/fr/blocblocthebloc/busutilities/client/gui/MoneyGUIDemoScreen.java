...
public class MoneyGUIDemoScreen extends AbstractContainerScreen<MoneyGUIDemoMenu> {
	private final static HashMap<String, Object> guistate = MoneyGUIDemoMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MoneyGUIDemoScreen(MoneyGUIDemoMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("busutilities:textures/screens/money_gui_demo.png");
