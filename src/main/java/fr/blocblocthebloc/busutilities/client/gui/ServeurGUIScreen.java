...
public class ServeurGUIScreen extends AbstractContainerScreen<ServeurGUIMenu> {
	private final static HashMap<String, Object> guistate = ServeurGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ServeurGUIScreen(ServeurGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("busutilities:textures/screens/serveur_gui.png");
