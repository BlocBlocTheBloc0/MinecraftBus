...
public class Controlegui4Screen extends AbstractContainerScreen<Controlegui4Menu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "" + (BusutilitiesModVariables.MapVariables.get(world).ticket_use_name_3) + "", 37, 15, -12829636);
		this.font.draw(poseStack, "" + (BusutilitiesModVariables.MapVariables.get(world).ticket_use_text_3) + "", 37, 51, -12829636);
		this.font.draw(poseStack, "" + (BusutilitiesModVariables.MapVariables.get(world).ticket_use_date_3) + "", 37, 96, -12829636);
		this.font.draw(poseStack, "" + (BusutilitiesModVariables.MapVariables.get(world).ticket_use_heure_3) + "", 37, 132, -12829636);
		this.font.draw(poseStack, "Page 4/10", 91, 177, -12829636);
	}
