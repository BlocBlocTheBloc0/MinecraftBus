...
public class MapCreditGUIScreen extends AbstractContainerScreen<MapCreditGUIMenu> {
	private final static HashMap<String, Object> guistate = MapCreditGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MapCreditGUIScreen(MapCreditGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("busutilities:textures/screens/map_credit_gui.png");
