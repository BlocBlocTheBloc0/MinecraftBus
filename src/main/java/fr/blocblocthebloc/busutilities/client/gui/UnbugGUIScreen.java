...
public class UnbugGUIScreen extends AbstractContainerScreen<UnbugGUIMenu> {
	private final static HashMap<String, Object> guistate = UnbugGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public UnbugGUIScreen(UnbugGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("busutilities:textures/screens/unbug_gui.png");
