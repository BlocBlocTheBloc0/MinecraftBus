...
public class BuyTicket1Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BuyTicket1Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(BusutilitiesModMenus.BUY_TICKET_1.get(), id);
