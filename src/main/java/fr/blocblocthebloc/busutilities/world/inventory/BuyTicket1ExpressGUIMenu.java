...
package fr.blocblocthebloc.busutilities.world.inventory;
...
public class BuyTicket1ExpressGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BuyTicket1ExpressGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(BusutilitiesModMenus.BUY_TICKET_1_EXPRESS_GUI.get(), id);
