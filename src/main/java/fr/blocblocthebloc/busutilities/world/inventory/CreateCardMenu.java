...
public class CreateCardMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CreateCardMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(BusutilitiesModMenus.CREATE_CARD.get(), id);
