...
public class BuyCarteEMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BuyCarteEMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(BusutilitiesModMenus.BUY_CARTE_E.get(), id);
