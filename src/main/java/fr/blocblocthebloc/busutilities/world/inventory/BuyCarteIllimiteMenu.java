...
public class BuyCarteIllimiteMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BuyCarteIllimiteMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(BusutilitiesModMenus.BUY_CARTE_ILLIMITE.get(), id);
