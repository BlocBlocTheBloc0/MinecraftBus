...
public class BuyCarte10Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BuyCarte10Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(BusutilitiesModMenus.BUY_CARTE_10.get(), id);
