...
public class BuyTicket10Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BuyTicket10Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(BusutilitiesModMenus.BUY_TICKET_10.get(), id);
