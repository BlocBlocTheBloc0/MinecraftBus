...
public class BuyTicket3Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BuyTicket3Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(BusutilitiesModMenus.BUY_TICKET_3.get(), id);
