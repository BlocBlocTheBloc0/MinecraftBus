 ...
 *
 */
package fr.blocblocthebloc.busutilities;
...
@Mod("busutilities")
public class BusutilitiesMod {
	public static final Logger LOGGER = LogManager.getLogger(BusutilitiesMod.class);
	public static final String MODID = "busutilities";

	public BusutilitiesMod() {
		MinecraftForge.EVENT_BUS.register(this);
		BusutilitiesModTabs.load();
