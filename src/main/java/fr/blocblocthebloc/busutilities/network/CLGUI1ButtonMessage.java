...
public class CLGUI1ButtonMessage {
	private final int buttonID, x, y, z;

	public CLGUI1ButtonMessage(FriendlyByteBuf buffer) {
	...
	public CLGUI1ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(CLGUI1ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(CLGUI1ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = CLGUI1Menu.guistate;
