...
public class MUGUI1ButtonMessage {
	private final int buttonID, x, y, z;

	public MUGUI1ButtonMessage(FriendlyByteBuf buffer) {
	...
	public MUGUI1ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(MUGUI1ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(MUGUI1ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = MUGUI1Menu.guistate;
