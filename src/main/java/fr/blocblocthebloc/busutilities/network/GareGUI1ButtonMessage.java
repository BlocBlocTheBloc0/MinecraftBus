...
public class GareGUI1ButtonMessage {
	private final int buttonID, x, y, z;

	public GareGUI1ButtonMessage(FriendlyByteBuf buffer) {
	...
	public GareGUI1ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(GareGUI1ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(GareGUI1ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = GareGUI1Menu.guistate;
