...
public class ShopchoixButtonMessage {
	private final int buttonID, x, y, z;

	public ShopchoixButtonMessage(FriendlyByteBuf buffer) {
	...
	public ShopchoixButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(ShopchoixButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(ShopchoixButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = ShopchoixMenu.guistate;
