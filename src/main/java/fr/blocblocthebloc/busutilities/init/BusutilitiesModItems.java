...
import fr.blocblocthebloc.busutilities.item.PlatineArmorItem;
...
public class BusutilitiesModItems {
	...
	public static final RegistryObject<Item> CARTEDETRANSPORT_ILLIMITE = REGISTRY.register("cartedetransport_illimite", () -> new CartedetransportIllimiteItem());
	...
	public static final RegistryObject<Item> PLATINE_ARMOR_HELMET = REGISTRY.register("platine_armor_helmet", () -> new PlatineArmorItem.Helmet());
	public static final RegistryObject<Item> PLATINE_ARMOR_CHESTPLATE = REGISTRY.register("platine_armor_chestplate", () -> new PlatineArmorItem.Chestplate());
	public static final RegistryObject<Item> PLATINE_ARMOR_LEGGINGS = REGISTRY.register("platine_armor_leggings", () -> new PlatineArmorItem.Leggings());
	public static final RegistryObject<Item> PLATINE_ARMOR_BOOTS = REGISTRY.register("platine_armor_boots", () -> new PlatineArmorItem.Boots());
