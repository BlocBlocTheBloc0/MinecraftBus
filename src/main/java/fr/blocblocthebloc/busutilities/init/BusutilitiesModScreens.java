...
import fr.blocblocthebloc.busutilities.client.gui.TheOneProbsGUIScreen;
...
import fr.blocblocthebloc.busutilities.client.gui.OptifineGUIScreen;
...
import fr.blocblocthebloc.busutilities.client.gui.ModsBusGUIScreen;
...
import fr.blocblocthebloc.busutilities.client.gui.JEIGUIScreen;
...
import fr.blocblocthebloc.busutilities.client.gui.CreateGUIScreen;
...
public class BusutilitiesModScreens {
	...
	public static void clientLoad(FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			...
			MenuScreens.register(BusutilitiesModMenus.MODS_BUS_GUI.get(), ModsBusGUIScreen::new);
			MenuScreens.register(BusutilitiesModMenus.CREATE_GUI.get(), CreateGUIScreen::new);
			MenuScreens.register(BusutilitiesModMenus.JEIGUI.get(), JEIGUIScreen::new);
			MenuScreens.register(BusutilitiesModMenus.THE_ONE_PROBS_GUI.get(), TheOneProbsGUIScreen::new);
			MenuScreens.register(BusutilitiesModMenus.OPTIFINE_GUI.get(), OptifineGUIScreen::new);
		});
	}
}
