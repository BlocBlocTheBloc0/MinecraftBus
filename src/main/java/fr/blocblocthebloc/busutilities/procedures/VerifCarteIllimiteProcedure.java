...
public class VerifCarteIllimiteProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (entity instanceof Player _playerHasItem
				? _playerHasItem.getInventory().contains(new ItemStack(BusutilitiesModItems.CARTEDETRANSPORT_ILLIMITE.get()))
				: false) {
			...
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(Component.literal("\u00A7aTitre de transport valide - Carte : \u00A7k?\u00A7r \u00A7aVoyages Restants"),
						(true));
		} else {
			if (entity instanceof Player _player && !_player.level.isClientSide())
