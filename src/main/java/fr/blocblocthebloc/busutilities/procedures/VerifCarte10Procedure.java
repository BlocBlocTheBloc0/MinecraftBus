...
public class VerifCarte10Procedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(BusutilitiesModItems.CARTEDETRANSPORT_10.get())) : false) {
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(BusutilitiesModItems.CARTEDETRANSPORT_9.get());
				_setstack.setCount(1);
				ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
			}
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(BusutilitiesModItems.CARTEDETRANSPORT_10.get());
			...
			BusutilitiesModVariables.MapVariables.get(world).last_ticket_use_text = "Carte type : 10V";
			BusutilitiesModVariables.MapVariables.get(world).syncData(world);
			...
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(Component.literal("\u00A7aTitre de transport valide - Carte : 9 Voyeages Restants"), (true));
		} else {
			VerifCarte109Procedure.execute(world, entity);
		}
	}
}
