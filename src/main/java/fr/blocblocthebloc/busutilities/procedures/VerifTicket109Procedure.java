...
public class VerifTicket109Procedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(BusutilitiesModItems.TICKET_10_VOYAGE_9.get())) : false) {
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(BusutilitiesModItems.TICKET_10_VOYAGE_8.get());
				_setstack.setCount(1);
				ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
			}
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(BusutilitiesModItems.TICKET_10_VOYAGE_9.get());
			...
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(Component.literal("\u00A7aTitre de transport valide - 8 Voyages Restants"), (true));
		} else {
			VerifTicket108Procedure.execute(world, entity);
		}
	}
}
